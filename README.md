...
### Solidity 101 — Section 3 — Remix Fund Me (In Progress)
...
*Chainlink oracles completely changed how I think about blockchains -
I assumed blockchains could access any data, but they're actually isolated
from the real world by design. The fact that a decentralized network of nodes
is needed just to bring in something as simple as a price feed shows how
carefully this technology is architected.*
